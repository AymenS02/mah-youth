// app/pages/dashboard/articles/[id]/edit/page.jsx
'use client';
import { useState, useEffect } from 'react';
import { useRouter, useParams } from 'next/navigation';
import Header from "/components/header/Header";
import { FileText, ArrowLeft, Save, X, Loader } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="pt-[200px] max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">The article you're trying to edit doesn't exist or may have been deleted.</p>
            <button
