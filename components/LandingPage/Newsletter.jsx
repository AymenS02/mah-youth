...
const Newsletter = () => {
  ...
  return (
    <section className="min-h-screen py-24 bg-gradient-primary text-center relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute top-0 left-1/4 w-64 h-64 bg-[var(--color-accent-light)]/20 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-[var(--btn-primary-bg)]/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
            <svg className="w-8 h-8 text-[var(--fg-light)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
          </div>

          <h2 className="text-5xl md:text-6xl font-bold text-gradient-accent mb-6 tracking-tight">
            Stay Updated
          </h2>
          
          <p className="text-xl text-[var(--fg-light)] opacity-90 mb-10 leading-relaxed max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="relative max-w-2xl mx-auto mb-8">
            <div className={`relative bg-white/10 backdrop-blur-md rounded-2xl p-2 border-2 transition-all duration-300 ${
              isFocused ? 'border-[var(--color-accent-light)] shadow-xl shadow-[var(--color-accent-light)]/20' : 'border-white/20'
            }`}>
              <div className="flex flex-col sm:flex-row gap-2">
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full px-6 py-4 rounded-xl bg-white text-[var(--fg-primary)] placeholder-[var(--fg-secondary)] focus:outline-none shadow-sm"
                    required
                  />
                  {/* Floating label effect */}
                  {email && (
                    <span className="absolute left-6 -top-2 text-xs font-semibold text-[var(--fg-light)] bg-gradient-primary px-2 rounded">
                      Email Address
                    </span>
                  )}
                </div>
                <button 
                  type="submit"
                  className="group relative bg-[var(--btn-primary-bg)] text-[var(--btn-primary-fg)] px-8 py-4 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 overflow-hidden flex items-center justify-center gap-2"
                >
                  ...
                  <div className="absolute inset-0 bg-[var(--btn-primary-hover)] translate-x-full group-hover:translate-x-0 transition-transform duration-300"></div>
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mb-8">
            <div className="flex items-center gap-2 text-[var(--fg-light)]/90">
          ...
          <div className="flex items-center justify-center gap-2 text-[var(--fg-light)]/70 text-sm">
          ...
          <div className="mt-10 pt-8 border-t border-white/10">
            <div className="flex items-center justify-center gap-2 text-[var(--fg-light)]/80">
